...
class AbstractModel:
    ...
    def conv(self, name, input_data, out_channel, kernel_size=3, stride=1, trainable=False, use_cudnn_on_gpu=True):
        """卷积方法"""
        ...
        with tf.variable_scope(name):
            ...
            # 卷积操作
            conv_res = tf.nn.conv2d(input_data, kernel, strides=[1, stride, stride, 1], padding='SAME', use_cudnn_on_gpu=use_cudnn_on_gpu)
    ...
    def fc(self, name, input_data, out_channel, trainable=False, is_output_layer=False):
        """全连接方法"""
